...
(function initI18n() {
  ...
  const DEFAULT_PORTAL_LABELS = {
    ...
    project_manager: { bn: 'প্রজেক্ট ম্যানেজার ড্যাশবোর্ড', en: 'Project Manager Dashboard' },
    employee: { bn: 'কর্মচারী ড্যাশবোর্ড', en: 'Employee Dashboard' },
    investor: { bn: 'বিনিয়োগকারী ড্যাশবোর্ড', en: 'Investor Dashboard' },
    external_investor: { bn: 'বহিঃস্থ বিনিয়োগকারী', en: 'External Investor Portal' },
